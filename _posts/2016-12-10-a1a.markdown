...
theme:
  ...
  card:
    ...
    light:
        title-color: "#AA1C0F"
        subtitle-color: "#B47A70"
        gradient:
          center-color: "#F4F1E8"
          outer-color: "#EDEAE1"
    dark:
        title-color: "#F7F0DE"
        subtitle-color: "#D7675D"
        gradient:
          center-color: "hsl(32, 16%, 32%)"
          outer-color: "hsl(33, 16%, 22%)"

title: "A1A"
author: "Michael Barrowclift"
date: 2016-12-10 22:58:00
image: a1a/images/album-art.jpg
album-art-article-override-light: album-art-article-override.jpg
album-art-article-override-dark: album-art-2000w.jpg
...
[^nautical-wheelers]: [There is a great video of a young Buffett performing "Nautical Wheelers" to a crowd in Key West](https://youtu.be/W3nhhZELugg). I love this video as it is so much fun to see a more intimate performance with Buffett. It is also a blast to watch all the different audience members really get into the performance.